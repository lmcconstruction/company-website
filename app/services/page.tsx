    ...
    <div className="mx-auto max-w-6xl px-6 py-16 md:py-24">
      <div className="max-w-xl">
        ...
        <p className="mt-5 text-[17px] leading-relaxed text-[var(--ink)]/80">
          Whether it's a full custom build or a single-room renovation, the
          same person oversees your project from quote to final walkthrough.
        </p>
      </div>
      ...
      <div className="mt-16 flex flex-wrap items-center gap-6 border-t border-[var(--forest-deep)]/10 pt-10">
